...
description: "Billing integrity — the errors here are commercial, not cosmetic. Scope: quotas, usage, plans, subscriptions, invoices — everything under `client.revenue`."
---
<!-- PROJECTED FILE — do not edit here.
     Source of truth: src/aegis_sdk/coc/guardrails/billing-integrity.md
