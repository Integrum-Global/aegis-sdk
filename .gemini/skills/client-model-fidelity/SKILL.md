---
name: client-model-fidelity
description: "Client-model fidelity — what the client omits, you never see. Scope: every response you read through a typed model, and every endpoint you are tempted to wrap because it exists."
---
<!-- PROJECTED FILE — do not edit here.
     Source of truth: src/aegis_sdk/coc/guardrails/client-model-fidelity.md
