...
def _normalize_objective(raw: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        # A null stays None. Coercing it to "" would hand the caller an empty
        # string that reads as a real workspace id and can be sent back as a
        # filter — a wrong answer in the grammar of a right one.
