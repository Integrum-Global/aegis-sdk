---
name: sentinels-and-defaults
description: "Sentinels and defaults — a value that cannot be distinguished from an intention. Scope: every field you read that might be a sentinel, and every argument you give a default."
---
<!-- PROJECTED FILE — do not edit here.
     Source of truth: src/aegis_sdk/coc/guardrails/sentinels-and-defaults.md
