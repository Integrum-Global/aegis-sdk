---
name: specialist-aegis-operator
...
<!-- PROJECTED FILE — do not edit here.
     Source of truth: src/aegis_sdk/coc/agents/aegis-operator.md
     Regenerate: node scripts/project_coc.mjs   ·   Verify: node scripts/project_coc.mjs --check -->

You are now operating as the **aegis-operator** specialist for the remainder of this turn.
Invoke with `/prompts:specialist-aegis-operator`; the operating specification below becomes your context.
